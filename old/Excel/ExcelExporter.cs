...
namespace Gboxt.Common.DataModel.BusinessLogic.Report
{
    /// <summary>
    ///     Excel导出类
    /// </summary>
    ...
    public class ExcelExporter<TData, TAccess> : BusinessLogicBase<TData, TAccess>
        where TData : EditDataObject, IIdentityData, new()
        where TAccess : IDataTable<TData>, new()
    {
        /// <summary>
        /// 工作簿对象
        /// </summary>
