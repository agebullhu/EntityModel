...
namespace Agebull.EntityModel.SqlServer
{
    ...
    public sealed class ConditionItem
    {
        ...
        /// </summary>
        public IEnumerable<SqlParameter> SqlParameter => _parameters.Values;
        ...
        public void AddOrCondition(string condition, IEnumerable<SqlParameter> parameters)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// <param name="condition"></param>
        /// <param name="parameters"></param>
        public void AddAndCondition(string condition, IEnumerable<SqlParameter> parameters)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// </summary>
        /// <param name="parameters"></param>
        public void AddParameter(IEnumerable<SqlParameter> parameters)
        {
