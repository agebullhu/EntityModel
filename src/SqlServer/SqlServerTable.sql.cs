...
namespace Agebull.EntityModel.SqlServer
{
    partial class SqlServerTable<TData, TDataBase>
    {
        ...
        private string FileUpdateSql(string field, object value, IList<SqlParameter> parameters)
        {
...
{AfterUpdateSql(condition)}";
        ...
        /// <param name="parameters">参数列表</param>
        /// <returns>更新的SQL</returns>
        private string CreateUpdateSql(string field, object value, string condition, IList<SqlParameter> parameters)
        {
