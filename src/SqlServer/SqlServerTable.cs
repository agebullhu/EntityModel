...
namespace Agebull.EntityModel.SqlServer
{
    ...
    public abstract class SqlServerTable<TData> : SimpleConfig, IDataTable<TData>
        where TData : EditDataObject, new()
    {
        ...
        {
            get => _dataBase ?? (_dataBase = SqlServerDataBase.DefaultDataBase ?? (_dataBase = SqlServerDataBase.DefaultDataBase = CreateDefaultDataBase()));
            set => _dataBase = value;
        }
        ...
        ///     表名
        /// </summary>
        public abstract string ReadTableName { get; }
        ...
        ///     表名
        /// </summary>
        public abstract string WriteTableName { get; }
    ...
    SELECT {ContextLoadFields},
      ...
      FROM {ContextReadTable}{ContitionSqlCode(condition)}
        ...
        public int PhysicalDelete(Expression<Func<TData, bool>> lambda)
        {
            ...
            {
                cnt = DeleteInner(convert.ConditionSql, convert.Parameters);
                if (cnt == 0)
                    return 0;
                scope.SetState(true);
            }
        ...
        Dictionary<string, string> IDataTable.FieldDictionary => FieldDictionary;


        int IDataTable.TableId => TableId;
