...
namespace Agebull.EntityModel.SqlServer
{
        ...
        where TDataBase : SqlServerDataBase
    {
        ...
        ///     生成命令
        /// </summary>
        protected SqlCommand CreateLoadCommand(string condition, string order, params SqlParameter[] args)
        {
        ...
        {
            return SqlServerDataBase.CreateParameter(KeyField, value, GetDbType(KeyField));
        }
        ...
        {
            return SqlServerDataBase.CreateParameter(KeyField, entity.GetValue(KeyField),
                GetDbType(KeyField));
        }
        ...
        /// 当前上下文的读取器
        /// </summary>
        public Action<SqlDataReader, TData> DynamicLoadAction { get; set; }
