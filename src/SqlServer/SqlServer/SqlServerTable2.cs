...
namespace Agebull.EntityModel.SqlServer
{
    ...
    public abstract partial class SqlServerTable<TData, TDataBase> : SimpleConfig, IDataTable<TData>
        ...
        where TDataBase : SqlServerDataBase
    {
        ...
        ///     生成命令
        /// </summary>
        protected SqlCommand CreateLoadCommand(string condition, params DbParameter[] args)
        {
        ...
        ///     生成命令
        /// </summary>
        protected SqlCommand CreateOnceCommand(string condition, string order, bool desc, params DbParameter[] args)
        {
        ...
        protected SqlCommand CreateLoadCommand(string order, bool desc, string condition,
        ...
        public DbParameter[] CreateFieldsParameters(params string[] fields)
        {
            ...
            return fields.Select(field => (DbParameter)new SqlParameter(field, GetDbType(field))).ToArray();
        }
        ...
        {
            return SqlServerDataBase_.CreateParameter(KeyField, value, GetDbType(KeyField));
        }
        ...
        {
            return SqlServerDataBase_.CreateParameter(KeyField, entity.GetValue(KeyField),
                GetDbType(KeyField));
        }
        ...
        public virtual void SimpleLoad(SqlDataReader reader, TData entity)
        {
        ...
        ///     设置更新数据的命令
        /// </summary>
        protected virtual void SetUpdateCommand(TData entity, SqlCommand cmd)
        {
        }
        ...
        protected virtual bool SetInsertCommand(TData entity, SqlCommand cmd)
        {
            return false;
        }
        ...
        /// <param name="reader">数据读取器</param>
        /// <param name="entity">读取数据的实体</param>
        protected virtual void LoadEntity(SqlDataReader reader, TData entity)
        {
        }
