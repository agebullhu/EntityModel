...
namespace Agebull.EntityModel.SqlServer
{
    partial class SqlServerTable<TData, TDataBase>
    {
        ...
        ///     分页读取
        /// </summary>
        public ApiPageData<TData> Page(int page, int limit, string condition, params SqlParameter[] args)
        {
        ...
        {
            return Page(page, limit, order, desc, condition, args.Cast<SqlParameter>().ToArray());
        }

        /// <summary>
        ///     分页读取
        /// </summary>
        public ApiPageData<TData> Page(int page, int limit, string order, string condition, params SqlParameter[] args)
        {
        ...
        ///     读取存储过程
        /// </summary>
        public List<TData> LoadDataByProcedure(string procedure, SqlParameter[] args)
        {
            var results = new List<TData>();
