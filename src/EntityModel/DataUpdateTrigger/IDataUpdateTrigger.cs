...
namespace Agebull.EntityModel.Common
{
    ...
    public interface IDataUpdateTrigger
    {
        ...
        void OnPrepareSave<TEntity>(TEntity entity, DataOperatorType operatorType) where TEntity : EditDataObject, new() { }
        ...
        /// <param name="entity">保存的对象</param>
        /// <param name="operatorType">操作类型</param>
        void OnDataSaved<TEntity>(TEntity entity, DataOperatorType operatorType) where TEntity : EditDataObject, new() { }
