...
namespace Agebull.Common
{
    ...
    public static class IdEncoder
    {
        ...
        {
            var timestampSegment = code.Substring(0, SmallFlakes.EncodingTimestampLength);

            var workerSegment = code.Substring(SmallFlakes.EncodingTimestampLength, SmallFlakes.EncodingWorkerLength);

            var localSegment = code.Substring(SmallFlakes.EncodingTimestampLength + SmallFlakes.EncodingWorkerLength, SmallFlakes.EncodingCounterLength);
