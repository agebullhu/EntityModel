...
using Agebull.Common.DataModel.ExtendEvents;
...
namespace Agebull.Common.DataModel.Sqlite
{
    partial class SqliteTable<TData, TSqliteDataBase>
    {
        ...
        public TData First(string condition, SQLiteParameter[] args)
        {
        ...
        /// <returns>如果有载入首行,否则返回空</returns>
        public TData FirstOrDefault(string condition, SQLiteParameter[] args)
        {
            return LoadFirst(condition, args);
        }
        ...
        /// </summary>
        /// <returns>是否存在数据</returns>
        public TData Last(string condition, SQLiteParameter[] args)
        {
        ...
        /// <param name="args">参数</param>
        /// <returns>如果有载入尾行,否则返回空</returns>
        public TData LastOrDefault(string condition, SQLiteParameter[] args)
        {
            return LoadLast(condition, args);
        }
        ...
        /// </summary>
        /// <returns>数据</returns>
        public List<TData> All(string condition, SQLiteParameter[] args)
        {
        ...
        ///     汇总方法
        /// </summary>
        public object Collect(string fun, string field, string condition, params SQLiteParameter[] args)
        {
        ...
        {
            var obj = CollectInner("Count", "*", condition, args.Cast<SQLiteParameter>().ToArray());
        ...
        /// <returns>如果有载入首行,否则返回空</returns>
        public long Count<TValue>(Expression<Func<TData, TValue>> field, string condition, params SQLiteParameter[] args)
        {
        ...
        ///     汇总
        /// </summary>
        public decimal Sum(string field, string condition, params SQLiteParameter[] args)
        {
        ...
        /// </summary>
        /// <returns>是否存在数据</returns>
        public bool Any(string condition, SQLiteParameter[] args)
        {
        ...
        ///     总数据量
        /// </summary>
        protected object CollectInner(string fun, string field, string condition, params SQLiteParameter[] args)
        {
        ...
        ///     分页读取
        /// </summary>
        public List<TData> PageData(int page, int limit, string condition, params SQLiteParameter[] args)
        {
        ...
        {
            return PageData(page, limit, order, desc, condition, args.Cast<SQLiteParameter>().ToArray());
        }
        ...
        ///     分页读取
        /// </summary>
        public List<TData> LoadData(int page, int limit, string order, string condition, params SQLiteParameter[] args)
        {
        ...
        ///     分页读取
        /// </summary>
        public List<TData> PageData(int page, int limit, string order, string condition, params SQLiteParameter[] args)
        {
            return PageData(page, limit, order, false, condition, args);
        }
        ...
        ///     分页读取
        /// </summary>
        public ApiPageData<TData> Page(int page, int limit, string condition, params SQLiteParameter[] args)
        {
        ...
        {
            return Page(page, limit, order, desc, condition, args.Cast<SQLiteParameter>().ToArray());
        }

        /// <summary>
        ///     分页读取
        /// </summary>
        public ApiPageData<TData> Page(int page, int limit, string order, string condition, params SQLiteParameter[] args)
        {
        ...
        ///     读取多个值
        /// </summary>
        protected List<object> LoadValuesInner(string field, string condition, params SQLiteParameter[] args)
        {
            var sql = CreateLoadValueSql(field, condition);
        ...
        ///     条件读取
        /// </summary>
        public List<TData> LoadData(string condition, params SQLiteParameter[] args)
        {
            return LoadDataInner(condition, args);
        }
        ...
        ///     如果存在的话读取首行
        /// </summary>
        public TData LoadFirst(string condition, params SQLiteParameter[] args)
        {
        ...
        ///     如果存在的话读取尾行
        /// </summary>
        public TData LoadLast(string condition, params SQLiteParameter[] args)
        {
        ...
        private TData LoadEntity(SQLiteDataReader reader)
        {
        ...
        ///     读取首行
        /// </summary>
        protected TData LoadFirstInner(string condition = null, SQLiteParameter args = null)
        {
        ...
        ///     读取首行
        /// </summary>
        protected TData LoadFirstInner(string condition, SQLiteParameter[] args)
        {
            TData entity = null;
        ...
        ///     读取尾行
        /// </summary>
        protected TData LoadLastInner(string condition = null, SQLiteParameter args = null)
        {
            return LoadLastInner(condition, args == null ? new SQLiteParameter[0] : new[] { args });
        }

        /// <summary>
        ///     读取尾行
        /// </summary>
        protected TData LoadLastInner(string condition, SQLiteParameter[] args)
        {
            TData entity = null;
        ...
        ///     读取全部
        /// </summary>
        protected List<TData> LoadDataInner(string condition = null, SQLiteParameter args = null)
        {
            return LoadDataInner(condition, args == null ? new SQLiteParameter[0] : new[] { args }, null);
        }

        /// <summary>
        ///     读取全部
        /// </summary>
        protected List<TData> LoadDataInner(string condition, SQLiteParameter[] args)
        {
        ...
        ///     读取全部
        /// </summary>
        protected List<TData> LoadDataInner(string condition, SQLiteParameter[] args, string orderBy)
        {
            var results = new List<TData>();
        ...
        /// </summary>
        protected List<TData> LoadDataBySql(string sql, SQLiteParameter[] args)
        {
            var results = new List<TData>();
        ...
        ///     读取存储过程
        /// </summary>
        public List<TData> LoadDataByProcedure(string procedure, SQLiteParameter[] args)
        {
            var results = new List<TData>();
