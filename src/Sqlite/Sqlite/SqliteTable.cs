...
namespace Agebull.Common.DataModel.Sqlite
{
    ...
    public abstract partial class SqliteTable<TData, TSqliteDataBase> : SimpleConfig, IDataTable<TData>
        ...
        where TSqliteDataBase : SqLiteDataBase
    {
        ...
        ///     生成命令
        /// </summary>
        protected SQLiteCommand CreateLoadCommand(string condition, string order, params SQLiteParameter[] args)
        {
        ...
        public SQLiteParameter[] CreateFieldsParameters(params string[] fields)
        {
            ...
            return fields.Select(field => new SQLiteParameter(field, GetDbType(field))).ToArray();
        }
        ...
        public SQLiteParameter[] CreateFieldsParameters(string[] fields, object[] values)
        {
            ...
            var res = new SQLiteParameter[fields.Length];
        ...
        {
            return SqLiteDataBase.CreateParameter(field, value, GetDbType(field));
        }
        ...
        public SQLiteParameter CreateFieldParameter(string field, TData entity)
        {
        ...
        public SQLiteParameter CreateFieldParameter(string field, DataObjectBase entity, string entityField)
        {
        ...
        {
            return SqLiteDataBase.CreateParameter(KeyField, value, GetDbType(KeyField));
        }
        ...
        /// </summary>
        /// <param name="entity">取值的实体</param>
        public SQLiteParameter CreatePimaryKeyParameter(TData entity)
        {
            return SqLiteDataBase.CreateParameter(KeyField, entity.GetValue(KeyField),
                GetDbType(KeyField));
        }
        ...
        /// 当前上下文的读取器
        /// </summary>
        public Action<SQLiteDataReader, TData> DynamicLoadAction { get; set; }
