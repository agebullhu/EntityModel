...
namespace Agebull.Common.DataModel.Sqlite
{
    ...
    public class TransactionScope : ITransactionScope
    {
        ...
        //private readonly SqliteDataBaseScope dbScope;*/
        /// <summary>
        ///     构造
        /// </summary>
        /// <param name="dataBase">数据库对象</param>
        private TransactionScope(SqLiteDataBase dataBase)
        {
            //dbScope = SqliteDataBaseScope.CreateScope(dataBase);
        ...
        public static TransactionScope CreateScope(SqLiteDataBase dataBase)
        {
