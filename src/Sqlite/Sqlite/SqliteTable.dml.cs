...
{AfterUpdateSql(PrimaryKeyConditionSQL)}";
        ...
        ///     条件删除
        /// </summary>
        private int DeleteByCondition(string condition, SQLiteParameter[] args)
        {
            int cnt;
            using (var scope = TransactionScope.CreateScope(DataBase))
            {
        ...
        ///     删除
        /// </summary>
        private int DeleteInner(string condition, params SQLiteParameter[] args)
        {
        ...
        public int SetCoustomValue<TKey>(string valueExpression, TKey key)
        {
            ...
            var arg2 = new List<SQLiteParameter>
            {
        ...
        /// <returns>更新行数</returns>
        public int SetValue(string field, object value, string condition, params SQLiteParameter[] args)
        {
        ...
        /// <param name="args">条件参数</param>
        /// <returns>更新行数</returns>
        public int SetValue(Expression<Func<TData, bool>> field, bool value, string condition, params SQLiteParameter[] args)
        {
        ...
        /// <param name="args">条件参数</param>
        /// <returns>更新行数</returns>
        private int SetValueByCondition(string field, object value, string condition, params SQLiteParameter[] args)
        {
        ...
        /// <param name="args">条件参数</param>
        /// <returns>更新行数</returns>
        private int SetValueInner(string field, object value, string condition, params SQLiteParameter[] args)
        {
        ...
        /// <param name="args">条件参数</param>
        /// <returns>更新行数</returns>
        private int DoUpdateValue(string field, object value, string condition, SQLiteParameter[] args)
        {
        ...
        /// <returns>更新行数</returns>
        public int SetMulitValue(string expression, Expression<Func<TData, bool>> condition, params SQLiteParameter[] args)
        {
            var convert = Compile(condition);
            var arg = new List<SQLiteParameter>();
            if (convert.HaseParameters)
                arg.AddRange(convert.Parameter);
            if (args.Length > 0)
                arg.AddRange(args);
        ...
        /// <param name="args">参数</param>
        /// <returns>更新行数</returns>
        public int SetMulitValue(string expression, string condition, SQLiteParameter[] args)
        {
        ...
        /// <param name="operatorType">操作类型</param>
        protected virtual void OnOperatorExecuting(DataOperatorType operatorType, string condition, IEnumerable<SQLiteParameter> args)
        {
        }
        ...
        /// <param name="args">参数值</param>
        /// <param name="operatorType">操作类型</param>
        protected virtual void OnOperatorExecutd(DataOperatorType operatorType, string condition, IEnumerable<SQLiteParameter> args)
        {
        }
        ...
        /// <param name="args">参数值</param>
        /// <param name="operatorType">操作类型</param>
        private void OnOperatorExecuting(string condition, IEnumerable<SQLiteParameter> args, DataOperatorType operatorType)
        {
            var sqlParameters = args as SQLiteParameter[] ?? args.ToArray();
        ...
        /// <param name="args">参数值</param>
        /// <param name="operatorType">操作类型</param>
        private void OnOperatorExecutd(string condition, IEnumerable<SQLiteParameter> args, DataOperatorType operatorType)
        {
            var mySqlParameters = args as SQLiteParameter[] ?? args.ToArray();
        ...
        ///     更新语句后处理(单个实体操作不引发)
        /// </summary>
        private void OnMulitUpdateEvent(DataOperatorType operatorType, string condition, SQLiteParameter[] args)
        {
            if (!GlobalEvent)
                return;
