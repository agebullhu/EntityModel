...
namespace Agebull.Common.DataModel.Sqlite
{
    ...
    {
        private readonly Dictionary<string, SQLiteParameter> _parameters = new Dictionary<string, SQLiteParameter>();

        /// <summary>
        ///     参数列表(调用时生成数组,请只读调用,可以设置)
        /// </summary>
        public IEnumerable<SQLiteParameter> Parameter => _parameters.Values;
        ...
        /// <param name="parameter"></param>
        public void AddAndCondition(string condition, SQLiteParameter parameter)
        {
        ...
        public void AddOrCondition(string condition, IEnumerable<SQLiteParameter> parameters)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// <param name="condition"></param>
        /// <param name="parameters"></param>
        public void AddAndCondition(string condition, IEnumerable<SQLiteParameter> parameters)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// <param name="condition"></param>
        /// <param name="parameter"></param>
        public void AddOrCondition(string condition, SQLiteParameter parameter)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// </summary>
        /// <param name="parameters"></param>
        public void AddParameter(IEnumerable<SQLiteParameter> parameters)
        {
