...
//        private DbReaderScope(IDataAccess<TEntity> table, string fields, Action<DbDataReader, TEntity> loadAction)
//        {
...
//        /// <returns></returns>
//        public static IDisposable CreateScope(IDataAccess<TEntity> table, string fields, Action<DbDataReader, TEntity> loadAction)
//        {
