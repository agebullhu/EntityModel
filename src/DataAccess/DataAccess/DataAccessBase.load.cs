...
namespace Agebull.EntityModel.Common
{
    partial class DataAccess<TEntity>
    {
        ...
        {
            var convert = SqlBuilder.Compile(lambda);
            return LoadPageData(1, -1, _option.PrimaryKey, false, convert.ConditionSql, convert.Parameters);
        }
        ...
        {
            return CollectInner(fun, _option.FieldMap[field], null, null);
        }
        ...
        public object Collect<TValue>(string fun, Expression<Func<TEntity, TValue>> field)
        {
            ...
            return CollectInner(fun, _option.FieldMap[expression.Member.Name], null, null);
        }
        ...
        {
            return CollectInner(fun, _option.FieldMap[field], condition, args);
        }
        ...
        {
            return ExistInner(SqlBuilder.PrimaryKeyConditionSQL, ParameterCreater.CreateParameter(_option.PrimaryKey, id, SqlBuilder.GetDbType(_option.PrimaryKey)));
        }
        ...
        {
            var expression = (MemberExpression)field.Body;
            var obj = CollectInner("Count", _option.FieldMap[expression.Member.Name], condition, args);
            return obj == DBNull.Value || obj == null ? 0 : Convert.ToInt64(obj);
        }
        #endregion
        ...
        {
            var obj = CollectInner("Min", _option.FieldMap[field], null, null);
        ...
        {
            var obj = CollectInner("Min", _option.FieldMap[field], condition, args);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
            ...
            string condition2 = null)
        {
            ...
            var obj = CollectInner("Min", _option.FieldMap[expression.Member.Name], condition, convert.Parameters);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
            ...
            Expression<Func<TEntity, bool>> b)
        {
            ...
            var convert1 = SqlBuilder.Compile(a);
            var convert2 = SqlBuilder.Compile(b);
            var obj = CollectInner("Min", _option.FieldMap[expression.Member.Name],
                $"({convert1.ConditionSql}) AND ({convert1.ConditionSql})"
                , convert1.Parameters.Union(convert2.Parameters).ToArray());
            if (obj == DBNull.Value || obj == null)
                return null;
        ...
        {
            var expression = (MemberExpression)field.Body;
            var obj = CollectInner("Min", _option.FieldMap[expression.Member.Name], condition, args);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
        ...
        {
            var obj = CollectInner("Max", _option.FieldMap[field], null, null);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
        ...
        {
            var obj = CollectInner("Max", _option.FieldMap[field], condition, args);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
            ...
            string condition2 = null)
        {
            ...
            var obj = CollectInner("Max", _option.FieldMap[expression.Member.Name], condition, convert.Parameters);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
            ...
            Expression<Func<TEntity, bool>> b)
        {
            ...
            var convert1 = SqlBuilder.Compile(a);
            var convert2 = SqlBuilder.Compile(b);
            var obj = CollectInner("Max", _option.FieldMap[expression.Member.Name],
                $"({convert1.ConditionSql}) AND ({convert1.ConditionSql})"
                , convert1.Parameters.Union(convert2.Parameters).ToArray());
            if (obj == DBNull.Value || obj == null)
                return null;
        ...
        {
            var expression = (MemberExpression)field.Body;
            var obj = CollectInner("Max", _option.FieldMap[expression.Member.Name], condition, args);
            if (obj == DBNull.Value || obj == null)
                return null;
            return Convert.ToDecimal(obj);
        }
        ...
        {
            var obj = CollectInner("Sum", _option.FieldMap[field], null, null);
        ...
        {
            var obj = CollectInner("Sum", _option.FieldMap[field], condition, args);
            return obj == DBNull.Value || obj == null ? 0M : Convert.ToDecimal(obj);
        }
            ...
            string condition2 = null)
        {
            ...
            var condition = condition2 == null
                ...
                : convert.ConditionSql == null
                    ? condition2
                    : $"({convert.ConditionSql}) AND ({condition2})";
            var obj = CollectInner("Sum", _option.FieldMap[expression.Member.Name], condition, convert.Parameters);
            return obj == DBNull.Value || obj == null ? 0M : Convert.ToDecimal(obj);
        }
            ...
            Expression<Func<TEntity, bool>> b)
        {
            ...
            var convert1 = SqlBuilder.Compile(a);
            var convert2 = SqlBuilder.Compile(b);
            var obj = CollectInner("Sum", _option.FieldMap[expression.Member.Name],
                $"({convert1.ConditionSql}) AND ({convert1.ConditionSql})"
                , convert1.Parameters.Union(convert2.Parameters).ToArray());
            return obj == DBNull.Value || obj == null ? 0M : Convert.ToDecimal(obj);
        }
        ...
        {
            var expression = (MemberExpression)field.Body;
            var obj = CollectInner("Sum", _option.FieldMap[expression.Member.Name], condition, args);
            return obj == DBNull.Value || obj == null ? 0M : Convert.ToDecimal(obj);
        }
        ...
        {
            var obj = LoadValue(Option.PrimaryKey, condition, args);
        ...
        {
            return PageData(page, limit, _option.PrimaryKey, false, null, null);
        }
        ...
        {
            return PageData(page, limit, _option.PrimaryKey, false, condition, args);
        }
        ...
        {
            var convert = SqlBuilder.Compile(lambda);
            return PageData(page, limit, _option.PrimaryKey, false, convert.ConditionSql, convert.Parameters);
        }
        ...
        {
            return Page(page, limit, _option.PrimaryKey, false, null, null);
        }
        ...
        {
            var convert = SqlBuilder.Compile(lambda);
            return Page(page, limit, _option.PrimaryKey, false, convert.ConditionSql, convert.Parameters);
        }
        ...
        {
            return Page(page, limit, _option.PrimaryKey, false, condition, args);
        }
        ...
        {
            var fn = GetPropertyName(field);
            var vl = LoadValueInner(fn, SqlBuilder.FieldConditionSQL(_option.PrimaryKey), ParameterCreater.CreateFieldParameter(_option.PrimaryKey, SqlBuilder.GetDbType(_option.PrimaryKey), key));
            ...
            Expression<Func<TEntity, bool>> lambda)
        {
            ...
            var convert = SqlBuilder.Compile(lambda);
            Debug.Assert(_option.FieldMap.ContainsKey(field));
        ...
        {
            return LoadFirstInner(SqlBuilder.PrimaryKeyConditionSQL, ParameterCreater.CreateParameter(_option.PrimaryKey, key, SqlBuilder.GetDbType(_option.PrimaryKey)));
        }
        ...
        private TEntity LoadEntity(DbDataReader reader)
        {
            ...
            _option.LoadEntity(reader, entity).Wait();
            return entity;
        }
        ...
        public bool IsUnique<TValue>(Expression<Func<TEntity, TValue>> field, object val, object key)
        {
            ...
            return !Exist($"({SqlBuilder.Condition(fieldName, "c_vl_")} AND {SqlBuilder.FieldConditionSQL(_option.PrimaryKey, "<>")}"
                , ParameterCreater.CreateParameter("c_vl_", val, SqlBuilder.GetDbType(fieldName))
        ...
        public bool IsUnique<TValue>(Expression<Func<TEntity, TValue>> field, object val)
        {
            if (Equals(val, default(TValue)))
                return false;
            var fieldName = GetPropertyName(field);
            return !Exist(SqlBuilder.Condition(fieldName, "c_vl_"),
                ParameterCreater.CreateParameter("c_vl_", val, SqlBuilder.GetDbType(fieldName)));
        }
