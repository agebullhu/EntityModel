    ...
    public static class GlobalDataInterfaces
    {
        ...
        public static class IAuditData
        {
            ...
            public static PropertyDefault AuditState = new PropertyDefault
            {
                ...
                PropertyFeatrue = PropertyFeatrue.Field | PropertyFeatrue.Interface,
        ...
        #region IOrganizationBoundaryData(组织边界数据)

        /// <summary>
        /// 实体名称
        /// </summary>
        public const string IOrganizationBoundaryQuery = "IOrganizationBoundaryQuery";

        /// <summary>
        /// 实体IOrganizationBoundaryData的数据结构
        /// </summary>
        public static class IOrganizationBoundaryData
        {
            #region 常量
            ...
            /// 实体名称
            /// </summary>
            public const string name = "IOrganizationBoundaryData";

            /// <summary>
            /// 实体名称
            /// </summary>
            public const string entityName = "IOrganizationBoundaryData";

            /// <summary>
            /// 实体标题
            /// </summary>
            public const string caption = "组织边界数据";

            /// <summary>
            /// 实体说明
            /// </summary>
            public const string description = @"组织边界数据";

            /// <summary>
            /// 数据表名称
            /// </summary>
            public const string tableName = "IOrganizationBoundaryData";

            /// <summary>
            /// 实体说明
            /// </summary>
            public const string primaryProperty = "OrganizationId";
            #endregion
            #region 字段
            ...
            /// 组织边界代码
            /// </summary>
            public static PropertyDefault BoundaryCode = new PropertyDefault
            {
                Name = "BoundaryCode",
                Caption = @"组织边界代码",
                PropertyType = typeof(string),
                ...
                CanNull = false,
                DbType = (int)MySqlConnector.MySqlDbType.VarString,
                FieldName = "org_boundary_code",
                JsonName = "boundaryCode",
                Entity = entityName,
