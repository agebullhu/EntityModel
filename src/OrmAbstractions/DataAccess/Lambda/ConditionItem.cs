...
namespace Agebull.Orm.Abstractions
{
    ...
    public sealed class ConditionItem
    {
        ...
        /// </summary>
        public IEnumerable<DbParameter> Parameter => _parameters.Values;
        ...
        /// <param name="parameter"></param>
        public void AddAndCondition(string condition, DbParameter parameter)
        {
        ...
        public void AddOrCondition(string condition, IEnumerable<DbParameter> parameters)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// <param name="condition"></param>
        /// <param name="parameters"></param>
        public void AddAndCondition(string condition, IEnumerable<DbParameter> parameters)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// <param name="condition"></param>
        /// <param name="parameter"></param>
        public void AddOrCondition(string condition, DbParameter parameter)
        {
            if (string.IsNullOrWhiteSpace(ConditionSql))
            {
                ConditionSql = condition;
        ...
        /// </summary>
        /// <param name="parameters"></param>
        public void AddParameter(IEnumerable<DbParameter> parameters)
        {
        ...
        public string AddParameter(object value)
        {
            ...
            _parameters.Add(name, OrmDataBase.CreateParameter(name, value));
            return name;
        }
