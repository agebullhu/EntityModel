    ...
    public sealed class EventDefaultModelDataOperator : IDataOperator<EventDefaultModel>, IEntityOperator<EventDefaultModel>
    {
        ...
        public static EntityStruct Struct => _struct ??= new EntityStruct
        {
            ...
            Properties = new List<EntityProperty>
            {
                ...
                new EntityProperty(EventBusDb.EventDefault_Struct_.EventName,7,"EventName","tb_event_default_test","event_name",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.EventCode,8,"EventCode","tb_event_default_test","event_code",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.Version,9,"Version","tb_event_default_test","version",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.Region,10,"Region","tb_event_default_test","region",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.EventType,11,"EventType","tb_event_default_test","event_type",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.ResultOption,12,"ResultOption","tb_event_default_test","result_option",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.SuccessOption,13,"SuccessOption","tb_event_default_test","success_option",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.App,14,"App","tb_event_default_test","app",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.Classify,15,"Classify","tb_event_default_test","classify",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.Tag,16,"Tag","tb_event_default_test","tag",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.Memo,17,"Memo","tb_event_default_test","memo",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.TargetType,18,"TargetType","tb_event_default_test","target_type",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.TargetName,19,"TargetName","tb_event_default_test","target_name",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                new EntityProperty(EventBusDb.EventDefault_Struct_.TargetDescription,20,"TargetDescription","tb_event_default_test","target_description",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update)
            }
        };
...
,`tb_event_default_test`.`event_code` AS `event_code`
,`tb_event_default_test`.`version` AS `version`
,`tb_event_default_test`.`region` AS `region`
,`tb_event_default_test`.`event_type` AS `event_type`
,`tb_event_default_test`.`result_option` AS `result_option`
,`tb_event_default_test`.`success_option` AS `success_option`
,`tb_event_default_test`.`app` AS `app`
,`tb_event_default_test`.`classify` AS `classify`
,`tb_event_default_test`.`tag` AS `tag`
,`tb_event_default_test`.`memo` AS `memo`
,`tb_event_default_test`.`target_type` AS `target_type`
,`tb_event_default_test`.`target_name` AS `target_name`
,`tb_event_default_test`.`target_description` AS `target_description`
";
...
LEFT JOIN`tb_event_subscribe` ON `tb_event_default_test`.`id` = `tb_event_subscribe`.`event_id` ";
