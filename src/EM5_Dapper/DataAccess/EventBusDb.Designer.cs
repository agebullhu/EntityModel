        ...
        public static class EventDefault_Struct_
        {
            ...
            public static EntityStruct Struct => _struct ??= new EntityStruct
            {
                ...
                Properties      = new List<EntityProperty>
                {
                    ...
                    new EntityProperty(EventName,1,"EventName","tb_event_default_test","event_name",ReadWriteFeatrue.Read | ReadWriteFeatrue.Insert | ReadWriteFeatrue.Update),
                }
            };
            ...
            /// 数据表名称
            /// </summary>
            public const string TableName = "tb_event_default_test";
            ...
            public static PropertyDefault Id = new PropertyDefault
            {
                ...
                FieldName      = "id",
                TableName      = "tb_event_default_test",
