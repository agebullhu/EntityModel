        ...
        protected void InitForm()
        {
            ...
            foreach (var value in values)
            {
                ...
                if (!args.ContainsKey(key))
                    args.Add(key, words.Length == 1 ? null : HttpUtility.UrlDecode(words[1]));
                else
                    args[key] = words.Length == 1 ? null : HttpUtility.UrlDecode(words[1]);
            }
        }
        ...
        private void InitQuery()
        {
            ...
            foreach (var value in values)
            {
                ...
                if (!_arguments.ContainsKey(key))
                    _arguments.Add(key, words.Length == 1 ? null : HttpUtility.UrlDecode(words[1]));
                else
                    _arguments[key] = words.Length == 1 ? null : HttpUtility.UrlDecode(words[1]);
            }
        }
