...
{
    partial class UserDataAccess
    {
        /// <summary>
        /// 下拉列表键
        /// </summary>
        private const string comboKey = "ui:combo:User";
        /// <summary>
        /// 下拉树键
        /// </summary>
        private const string treeKey = "ui:tree:User";
        ...
        protected sealed override void OnDataSaved(UserData entity)
        {
            using (var proxy = new RedisProxy(RedisProxy.DbComboCache))
            {
