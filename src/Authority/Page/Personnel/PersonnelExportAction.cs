...
namespace Agebull.SystemAuthority.Organizations.PersonnelPage
{
    ...
    /// 职员
    /// </summary>
    public class ExportAction : ExportPageBase<PersonnelData, PersonnelDataAccess>
    {
        /// <summary>
        /// 导出表名称
        /// </summary>
        protected override string Name => "职员";

        /// <summary>
        /// 当前数据筛选器
        /// </summary>
        /// <returns></returns>
        protected override LambdaItem<PersonnelData> GetFilter()
        {
