...
namespace Agebull.SystemAuthority.Organizations.PositionPage
{
    public partial class Action : ApiPageBaseForAudit<PositionData, PositionDataAccess, PositionBusinessLogic>
    {
        /// <summary>
        /// 构造
        /// </summary>
        ...
        protected override void ReadFormData(PositionData data, FormConvert convert)
        {
