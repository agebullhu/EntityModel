...
namespace Agebull.SystemAuthority.Organizations.AreaPage
{
    partial class Action
    {
        ...
        protected void DefaultGetListData(LambdaItem<AreaData> filter)
        {
            SetKeywordFilger(filter);
        }
        ...
        protected void DefaultReadFormData(AreaData data, FormConvert convert)
        {
            //数据
            data.AreaId = convert.ToInteger("AreaId");
