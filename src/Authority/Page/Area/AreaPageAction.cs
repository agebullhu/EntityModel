/*此标记表明此文件可被设计器更新,如果不允许此操作,请删除此行代码.design by:agebull designer date:2017/6/2 17:11:50*/
using System;
...
{
    public partial class Action : ApiPageBaseEx<AreaData, AreaDataAccess, AreaBusinessLogic>
    {
        /// <summary>
        /// 构造
        /// </summary>
        ...
        protected override void ReadFormData(AreaData data, FormConvert convert)
        {
