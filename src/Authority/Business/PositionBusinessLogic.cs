...
namespace Agebull.SystemAuthority.Organizations.BusinessLogic
{
    ...
    /// 职位字典
    /// </summary>
    public sealed partial class PositionBusinessLogic : BusinessLogicByAudit<PositionData,PositionDataAccess>
    {
        /*// <summary>
        ///     保存前的操作
        /// </summary>
        ...
        protected override bool OnSaving(PositionData data, bool isAdd)
        {
        ...
        /// <param name="isAdd">是否为新增</param>
        /// <returns>如果为否将阻止后续操作</returns>
        protected override bool OnSaved(PositionData data, bool isAdd)
        {
