...
namespace Agebull.Common.Configuration
{
    ...
    public class MachineConfig
    {
        ...
        public Dictionary<string, Settings> Projects { get; set; }
        ...
        public void Initialize()
        {
            config = new ConfigurationBuilder()
                ...
                .AddJsonFile(@"c:\wwwroot\config\MachineConfig.json", optional: true, reloadOnChange: true)
                .Build();

            var sp = new ServiceCollection().AddOptions()
                .Configure<MachineConfig>(config)
                .BuildServiceProvider();

            _configuration = sp.GetService<IOptions<MachineConfig>>();
        }
