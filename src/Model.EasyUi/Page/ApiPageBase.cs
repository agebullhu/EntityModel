    ...
    public abstract class ApiPageBase : MyPageBase
    {
        ...
        private bool CanDoAction(string action)
        {
            ...
            if (IsPublicPage || AllAction)
                return true;
            return ModelContext.PowerChecker.CanDoAction(LoginUser, PageItem, action);
#endif 
        }
        /// <summary>
        ///     检查动作是否允许
        ...
        protected override bool CheckCanDo()
        {
            ...
            ModelContext.PowerChecker.SavePageAction(this.PageItem.Id, _action, _action, _action,"action");
        ...
        protected override void OnPrepare()
        {
            ...
            if (!IsPublicPage)
            {
                ...
                ModelContext.PowerChecker.SavePageAction(PageItem.Id, _action, _action, _action, "action");
            }
