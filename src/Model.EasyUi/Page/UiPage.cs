    ...
    public class UiPage : MyPageBase
    {
        ...
        protected string UiButtons
        {
            get
            {
                ...
                var buttons = ModelContext.PowerChecker.LoadPageButtons(ModelContext.LoginUser, PageItem);
        ...
        protected string PreQueryArgs
        {
            get
            {
                var preargs = ModelContext.PowerChecker.LoadQueryHistory(LoginUser, PageItem);
